  ...
  return (
    <>
      ...
      <Text size="lg" color="white" style={{ float: "right" }}>
        <b style={{ fontSize: "1em" }}>👤</b> {typeof informacoesBasicas == "object" ? informacoesBasicas?.nome : nome }&nbsp;&nbsp;
      </Text>
      <Text>
      ...
      <Box p="xs">
        ...
        <Box>
         ...
         <Box color="purpleCyan" rounded="lg" p="xs" m="xs">
            <Heading>
              <Text color="black">
                São menos que {estado ?"15": "20"} {nome}'s {estado ?"neste estado": "no Brasil"}
              </Text>
            </Heading>
            </Box>
            <Box color="purpleCyan" rounded="lg" p="xs" m="xs">
            <Heading>
              <Text color="black">
               infelizmente a falta de registros nos impede de fornecer mais detalhes ;/
              </Text>
            </Heading>
            </Box>
