...
function Agrupar() {
  ...
  const handleBusca = async () => {
    ...
    temp.sort((a : ISecoes,b : ISecoes)=> {
      if(a.basica != null && a.basica.length > 0 && b.basica != null && b.basica.length > 0){
          ...
          <Table>
            {
              ...
              <>
                <thead>
                <tr>
                  <th className="drac-text drac-text-white">Nomes informados</th>
              ...
              <tbody>
                <tr>
                  <td className="drac-text drac-text-white">Insira pelo menos dois nomes</td>
                </tr>
              </tbody>
              </>
            }
      ...
      <br/>
    {
      ...
      {dados.map((i: ISecoes, c: number) =>{
        ...
        if(i.basica != null && i.basica.length > 0){
          return (
            <Box 
            className={"i-am-" + i.basica[0].nome}
            key={c} p="xs">
              <Card style={{ borderColor: "purple" }} variant="subtle" p="sm">
                <Heading>
                {c == 0 ? "🏆 " : ""}
                {c == 1 ? "🥈 " : ""}
                {c == 2 ? "🥉 " : ""}
