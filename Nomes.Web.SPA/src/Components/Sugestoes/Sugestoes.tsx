  ...
  return (
    <>
      ...
      <Box>
        {!send ? (
          <>
            <Heading>Nos ajude a crescer</Heading>
            <Text as="p">Contribua com sugestões de qualquer tipo 😁</Text>
            <textarea
              value={msg}
              style={style}
              ...
              className="drac-input drac-input-white drac-text-white"
            ></textarea>
          ...
          <>
            <Heading size="xl">Obrigado pela mensagemn</Heading>
